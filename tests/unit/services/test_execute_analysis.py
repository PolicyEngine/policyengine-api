...
class TestExecuteAnalysis:
    def test_execute_analysis_static(self, get_tracer, parse_tracer_output, get_existing_analysis):
        """
        ...
        analysis, analysis_type = service.execute_analysis("us", "71424", "2", "market_income")

        assert analysis == "Existing static analysis"
        assert analysis_type == "static"

    def test_execute_analysis_streaming(self, get_tracer, parse_tracer_output, get_existing_analysis, trigger_ai_analysis):
        """
