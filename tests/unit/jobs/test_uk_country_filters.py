...
class TestUKCountryFilters:
    ...
    def test_uk_country_england_filter(self, mock_huggingface_downloads, mock_country, mock_h5py_weights, 
                                       mock_constituency_names, mock_simulation):
        ...
        mock_country.country_package.Microsimulation.return_value = mock_simulation
        
        # Call the method with country/england region
        with mock.patch("policyengine_api.jobs.calculate_economy_simulation_job.ENHANCED_FRS", "mock_dataset"):
            job._create_simulation_uk(mock_country, {}, "country/england", "2025")
        
        # Check that calculate was called
        mock_simulation.calculate.assert_called_with("household_net_income", 2025)
        ...
        mock_simulation.get_holder("person_weight").delete_arrays.assert_called_once()
        mock_simulation.get_holder("benunit_weight").delete_arrays.assert_called_once()

    def test_uk_country_scotland_filter(self, mock_huggingface_downloads, mock_country, mock_h5py_weights, 
                                        mock_constituency_names, mock_simulation):
        ...
        with mock.patch("policyengine_api.jobs.calculate_economy_simulation_job.ENHANCED_FRS", "mock_dataset"):
            job._create_simulation_uk(mock_country, {}, "country/scotland", "2025")
    ...
    def test_uk_country_wales_filter(self, mock_huggingface_downloads, mock_country, mock_h5py_weights, 
                                     mock_constituency_names, mock_simulation):
        ...
        with mock.patch("policyengine_api.jobs.calculate_economy_simulation_job.ENHANCED_FRS", "mock_dataset"):
            job._create_simulation_uk(mock_country, {}, "country/wales", "2025")
    ...
    def test_uk_country_ni_filter(self, mock_huggingface_downloads, mock_country, mock_h5py_weights, 
                                  mock_constituency_names, mock_simulation):
    ...
    def test_uk_without_region_filter(self, mock_huggingface_downloads, mock_country, mock_simulation):
