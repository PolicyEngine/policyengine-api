...
APP_V2_WORKFLOW_CONTRACTS: tuple[WorkflowContract, ...] = (
    ...
    WorkflowContract(
        name="household_resources_v2",
        current_contract="typed_v2_resources",
        future_owner_pr="PR 11: Household Migration",
        requests=(
            ContractRequest(
                method="POST",
                path="/v2/households?country_id=us",
                expected_status=201,
                stable_response_fields=(
                    "status",
                    "message",
                    "result.item.id",
                    "result.item.country_id",
                    "result.item.default_year",
                    "result.item.household_data",
                    "result.item.created_at",
                    "result.item.updated_at",
                ),
                route_group="household",
            ...
            ContractRequest(
                method="GET",
                path="/v2/households/{household_id}?country_id=us",
                expected_status=200,
                stable_response_fields=(
                    "status",
                    "message",
    ...
    WorkflowContract(
        name="user_household_associations_v2",
        current_contract="typed_v2_resources",
        future_owner_pr="PR 11: Household Migration",
        requests=(
            ContractRequest(
                method="POST",
                path="/v2/user-households?country_id=us",
                expected_status=201,
                stable_response_fields=(
                    "status",
                    "message",
            ...
            ContractRequest(
                method="GET",
                path="/v2/user-households/{association_id}?country_id=us",
                expected_status=200,
                stable_response_fields=(
                    "status",
                    "message",
            ...
            ContractRequest(
                method="GET",
                path="/v2/user-households?country_id=us&user_id={user_id}",
                expected_status=200,
                stable_response_fields=(
                    "status",
                    "message",
