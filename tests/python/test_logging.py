...
class TestLogger:
    def test_logger_initialization(self, temp_log_dir, mock_datetime):
        ...
        logger = Logger(
            dir=str(temp_log_dir), name=TEST_LOGGER_NAME, log_to_cloud=False
        )
        ...
        expected_log_dir = temp_log_dir
        assert expected_log_dir.exists()

        # Verify log file creation
        expected_log_file = expected_log_dir / (
            TEST_LOGGER_NAME + "_" + TEST_LOGGER_ID + ".log"
        )
    ...
    def test_cloud_logging_initialization(
        ...
        logger = Logger(
            dir=str(temp_log_dir), name=TEST_LOGGER_NAME, log_to_cloud=True
        )
