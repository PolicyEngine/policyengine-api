...
- Add temporary Stage 12 comparison status and private artifact metadata so automatic society-wide comparison runs can record exact aggregate differences without changing user-visible results.
...
- Add API v2 immutable households and user-household associations with immediate API v1 household copying.
...
- Update the PolicyEngine bundle to 4.18.8.
