...
env_vars=(
  ...
  "ROUTE_IMPL_HOUSEHOLD=${ROUTE_IMPL_HOUSEHOLD}"
  "DB_READ_POLICY=${DB_READ_POLICY}"
  "DB_WRITE_POLICY=${DB_WRITE_POLICY}"
  "DB_READ_HOUSEHOLD=${DB_READ_HOUSEHOLD}"
  "DB_WRITE_HOUSEHOLD=${DB_WRITE_HOUSEHOLD}"
  ...
  "OTEL_EXPORTER_OTLP_ENDPOINT=https://policyengine-api-v1-otel-collector-790230211054.us-central1.run.app"
  "OTEL_EXPORTER_OTLP_PROTOCOL=grpc"
  "OTEL_TRACES_EXPORTER=otlp"
  "OTEL_METRICS_EXPORTER=otlp"
  "OTEL_TRACES_SAMPLER_ARG=1.0"
  "POLICYENGINE_OTEL_GOOGLE_AUDIENCE=https://policyengine-api-v1-otel-collector-790230211054.us-central1.run.app"
