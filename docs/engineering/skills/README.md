...
- `api-routes.md`: mandatory shared typed query-parameter conventions for new
  routes and existing query-contract changes.
- `alembic-migrations.md`: mandatory autogenerated Alembic revision workflow,
  deployment safeguards, and migration validation.
