...
application-service, policy-persistence, and association-persistence modules.
The configured file set deliberately excludes the existing v1 implementation:
